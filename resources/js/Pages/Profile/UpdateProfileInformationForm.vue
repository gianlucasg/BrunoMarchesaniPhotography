<template>
    <jet-form-section @submitted="updateProfileInformation">
        ...
        <template #description>
            Actualice la información y correo electrónico de su cuenta.
        </template>
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4" v-if="$page.jetstream.managesProfilePhotos">
                ...
                <jet-secondary-button :color="'#e4b747'" class="mt-2" type="button" @click.native.prevent="selectNewPhoto">
        ...
        <template #actions>
            ...
            <jet-button :color="'#4b924e'" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                Guardar
            </jet-button>
        </template>
    </jet-form-section>
