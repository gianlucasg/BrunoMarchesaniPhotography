    ...
    <jet-action-section>
        ...
        <template #content>
            ...
            <div class="flex items-center mt-5">
                <jet-button :color="'#ca3535'" @click.native="confirmLogout">
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="confirmingLogout = false">
                ...
                <template #footer>
                    <jet-secondary-button :color="'#ca3535'" @click.native="confirmingLogout = false">
                        Nevermind
                    </jet-secondary-button>

                    <jet-button :color="'#4b924e'" class="ml-2" @click.native="logoutOtherBrowserSessions" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                        Logout Other Browser Sessions
                    </jet-button>
                </template>
            </jet-dialog-modal>
