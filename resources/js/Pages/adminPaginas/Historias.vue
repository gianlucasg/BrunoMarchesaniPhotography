				...
				<v-container class="hidden-md-and-up">
					<v-row>
						<v-col align="center" justify="center" cols="12" xs="12" sm="12" md="6" lg="6">
							<modal ref="modal" @modificaralbum="modificarAlbum" @subiralbum="subir" rutapost='/admin/historias' elemento='álbum'></modal>
						</v-col>
						<v-col  align="center" justify="center" cols="12" xs="12" sm="12" md="6" lg="6">
						<v-pagination
...
<script>
  ...
  export default {
    ...
    mounted(){
	    ...
	    this.ruta=window.location.pathname.slice(0,16); //SOLUCION BUG RUTA
